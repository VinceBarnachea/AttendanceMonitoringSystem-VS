...
Module Module1
    ...
    Public Sub AssignValidation(ByRef CTRL As Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        ...
        Select Case Validation_Type
            ...
            Case ValidationType.no_Symbol
                AddHandler txt.KeyPress, AddressOf no_Symbol
        End Select
    End Sub

    Public Sub no_Symbol(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
...
'Sample Usage = AssignValidation(Me.txtcontact, ValidationType.Only_Numbers)
